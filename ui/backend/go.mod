module github.com/khulnasoft/postee/ui/backend

go 1.18

require (
	github.com/khulnasoft/postee/v2 v2.6.0
...
require (
	...
	github.com/khulnasoft-lab/go-jira v0.0.0-20211103111421-b62ce48827be // indirect
