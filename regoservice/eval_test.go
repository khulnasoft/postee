...
func TestEval(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			inputFile:    "testdata/inputs/khulnasoft-input.json",
		...
		},
		{
			...
			expectedValues: map[string]string{
				"title":         "Khulnasoft security | image | all-in-one:3.5.19223 | Scan report",
		...
		},
		{
			...
			inputFile:    "testdata/inputs/khulnasoft-incident-input.json",
		...
		},
		{
			...
			inputFile:    "testdata/inputs/khulnasoft-insight-input.json",
